...
class Logger
{
    ...
    private:
        ...
        inline void all_ctors_actions([[maybe_unused]] std::string_view name, bool need_log_call_place, const std::source_location& location);   
...
inline void Logger::all_ctors_actions([[maybe_unused]] std::string_view name, bool need_log_call_place, const std::source_location& location)
{
