...
#define SET_NODE_FUNCTIONALITY(NodeT, ...)                                \
  template <>                                                             \
  inline ParaCL::frontend::ast::node::BasicNode                           \
  ParaCL::frontend::ast::node::create(NodeT node)                         \
  {                                                                       \
    return ParaCL::frontend::ast::node::BasicNode::Actions<__VA_ARGS__>:: \
...
#define SET_ALL_NODE_SAME_FUNCTIONALITY(...)                                  \
  ...
  SET_NODE_FUNCTIONALITY(                                                     \
      ParaCL::frontend::ast::node::UnaryOperator, __VA_ARGS__                 \
  )                                                                           \
  SET_NODE_FUNCTIONALITY(                                                     \
      ParaCL::frontend::ast::node::BinaryOperator, __VA_ARGS__                \
  )                                                                           \
  ...
  SET_NODE_FUNCTIONALITY(                                                     \
      ParaCL::frontend::ast::node::StringLiteral, __VA_ARGS__                 \
  )                                                                           \
  ...
  SET_NODE_FUNCTIONALITY(                                                     \
      ParaCL::frontend::ast::node::FunctionCall, __VA_ARGS__                  \
  )                                                                           \
  SET_NODE_FUNCTIONALITY(                                                     \
      ParaCL::frontend::ast::node::FunctionDeclaration, __VA_ARGS__           \
  )
