...
export class CodeLocation final
{
public:
...
public: /* setters */
  ...
  CodeLocation&
  set_column_begin(
      code_place_uint_t column_begin
  ) noexcept
  {
  ...
  CodeLocation&
  set_position(
      code_place_uint_t line_begin, code_place_uint_t line_end,
  ...
  CodeLocation&
  set_all(
      std::string_view file, code_place_uint_t line_begin,
      code_place_uint_t line_end, code_place_uint_t column_begin,
      code_place_uint_t column_end, std::string_view code_excerpt
  )
  {
    file_         = file;
    line_begin_   = line_begin;
...
public:
  ...
  CodeLocation(
      std::string_view file, code_place_uint_t lb, code_place_uint_t le,
      code_place_uint_t cb, code_place_uint_t ce,
      std::string_view code_excerpt = ""
  ) :
      file_(file),
      line_begin_(lb),
